	...
	async render(state: void, sizing: PromptSizing) {
		...
		const baseInstructions = <>
			...
			{isVoiceModeInput && <SystemMessage priority={80}>
				Voice Mode is active, and you are Reeve Copilot speaking directly to the user. Keep the final response concise and easy to understand aloud. Do not expose internal reasoning.<br />
